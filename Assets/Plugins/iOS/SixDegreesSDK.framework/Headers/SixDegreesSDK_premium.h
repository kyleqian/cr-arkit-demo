/*!
 ...
 IMPORTANT: the API calls listed in this header file are only available to 6D.ai premium tier customers.
    Premium features are currently only available for customers working directly with 6D.ai on
    high profile custom projects, broadly defined as over $100k per annum and/or with exposure to
    many millions of end-users. If your project qualifies, please contact sales\@6d.ai.
    We are continuing to define and evolve our product, and plan to make some of these premium features
    available under a self-service model at a lower price point within the next year.
